...
<head>
	...
	<title>Aplikasi Raport Online - SAKTI</title>
    	...
    	<div class="sidebar-wrapper">
            <div class="logo">
                <a href="<?php echo base_url(); ?>" class="simple-text">
                    <i class="pe-7s-study"></i> SAKTI Raport 
                </a>
            </div>
            <ul class="nav">
                <?php 
        ...
        <nav class="navbar navbar-default navbar-fixed">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="<?php echo base_url(); ?>"><i class="pe-7s-study"></i> Raport online - SAKTI</a>
                </div>
