...
<body>
	...
	<table>
		...
		<tr>
			<td width="20%">Nama Sekolah</td><td width="1%">:</td><td width="39%" class="tbl">SMK Sakti Gemolong</td>
			<td width="20%">Kelas</td><td width="1%">:</td><td width="19%" class="tbl"><?php echo strtoupper($wali_kelas['nama_kelas']); ?></td>
		</tr>
		<tr>
			<td>Alamat Sekolah</td><td>:</td><td class="tbl">Jl. Raya Sukowati Km 1, Gemolong, Sragen 57274</td>
			...
			<td colspan="6">
				...
				<table width="100%">
					<tr>
						...
						<td width="10%"></td>
						<td width="30%">
							Gemolong, <?php echo $this->config->item('tgl_cetak'); ?><br>
							Kepala SMK Sakti Gemolong <br>
							<br><br><br><br>
							<u><b>Drs. Suyono, M.Pd.</b></u><br>
							NIP. -
						</td>
					</tr>
				</table>
