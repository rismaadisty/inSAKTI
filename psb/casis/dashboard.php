  ...
  <div class="col-lg-12">
    <div class="box">
      ...
      <div class="alert alert-info">
        ...
        <li>Klik menu <b>Input Mata Pelajaran</b> untuk memilih mata pelajaran yang akan diinputkan nilai raport nya. Pilih dan Klik <b>HANYA</b> 1 kali untuk setiap mata pelajaran. Setiap mata pelajaran yang dipilih akan ditampilkan kedalam menu <b>Input Nilai Raport</b>.</li>
        <li>Klik <b>Input Nilai Raport</b> untuk menginputkan nilai raport. Nilai raport yang diinput mulai dari nilai raport kelas VII sampai dengan nilai raport kelas IX.</li>
      </div>

      <div class="alert alert-info">
        Upload/unggah kelengkapan dokumen dibawah ini untuk keperluan verifikasi.<br>
        <li>Kartu keluarga.</li>
        <li>Ijazah/Surat Hasil Ujian Nasional (SHUN)/Surat Keterangan Lulus (SKL)<b>*)</b>.</li>
        ...
        <br>
        Keterangan:<br>
        <b>*)</b> Pilih salah satu, mana yang dikeluarkan lebih dulu oleh pihak sekolah. Jika ijazah sudah diterbitkan oleh sekolah, sebaiknya gunakan ijazah untuk memenuhi kelengkapan dokumen.
      </div>
