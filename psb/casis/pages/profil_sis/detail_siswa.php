        ...
        <input type='hidden' name='tid' value="<?php echo $r['no_reg']; ?>" >
          ...
          <p>
            <div class="box-body pad">
              ...
              <textarea class="textarea" name="alamat_ortu" placeholder="Alamat lengkap orangtua siswa." required style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"><?php echo $r['alamat_orgtua']; ?></textarea>
            </div>
          </p>
