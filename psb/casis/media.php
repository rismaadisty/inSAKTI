      ...
      <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
          <ul class="nav nav-sidebar">
            <li class="active"><a href="?page=home">Dashboard</a></li>
            <li><a href="?page=unggah">Unggah Dokumen</a></li>
            <li><a href="?page=mapel">Input Mata Pelajaran</a></li>
            <li><a href="?page=nilai-raport">Input Nilai Raport</a></li>
            <li><a href="?page=ujian">Ujian Saringan Masuk</a></li>
          </ul>
        </div>
