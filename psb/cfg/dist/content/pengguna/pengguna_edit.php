        ...
        <form action="?page=upuser" method="post" enctype="multipart/form-data">
          ...
          <div class="form-group">
            ...
            ?>
                ...
                <div class="col-lg-8">
                  <input class="uniform" type="radio" name="aktif" value="Y" checked > Ya
                  <input class="uniform" type="radio" name="aktif" value="N" > Tidak
                </div>
          ...
          <div class="form-group">
            ...
            ?>
                ...
                <div class="col-lg-8">
                  <input class="uniform" type="radio" name="status" value="Admin" checked > Administrator
                  <input class="uniform" type="radio" name="status" value="User" > User
                </div>
              ...
              <?php } else { ?>
                ...
                <div class="col-lg-8">
                  <input class="uniform" type="radio" name="status" value="Admin" > Administrator
                  <input class="uniform" type="radio" name="status" value="User" checked > User
                </div>
              <?php } ?>
          </div>
