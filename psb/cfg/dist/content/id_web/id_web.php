    ...
    <div class="box">
      ...
      <div id="div-1" class="body collapse in">
        <form action="?page=upcridweb" method="post">
          ...
          <div class="form-group">
            <label for="text1" class="control-label col-lg-4">Meta Deksripsi</label>
            <div class="col-lg-8">
              <textarea id="wysihtml5" class="form-control" rows="10" name="meta_desk"><?php echo $r['meta_deskripsi']; ?></textarea>
            </div>
          </div>

          <div class="form-group">
            <label for="text1" class="control-label col-lg-4">Meta Keyword</label>
            <div class="col-lg-8">
              <textarea id="wysihtml5" class="form-control" rows="10" name="meta_key"><?php echo $r['meta_keyword']; ?></textarea>
            </div>
          </div>
